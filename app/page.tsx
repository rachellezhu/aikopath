      ...
      <section className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center mb-16">
        <div>
          ...
          <div className="bg-gray-900 p-4 rounded-xl border border-gray-800">
            ...
            <button
              onClick={generate}
              className={`w-full ${loading || splitInput.length < 2 || trimmedInput.length < 10 ? "bg-gray-600 text-gray-200" : "bg-blue-500 hover:bg-blue-600 cursor-pointer"} transition px-4 py-2 rounded-lg font-medium`} disabled={loading || splitInput.length < 2 || trimmedInput.length < 10}
            >
